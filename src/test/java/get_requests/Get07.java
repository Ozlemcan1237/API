...
//        Print all ids greater than 190 on the console ==> id si 190 dan buyuk olanlarin id lerini konsola yazdirin
        ...
        List<Object> list = jsonPath.getList("findAll{it.id>190}.id"); // filtreleme yapip id si 190 dan buyuk olanlari verecek
//       Groovy Language Java temelli bir programlama dilidir(Rest assured ile geliyor)
...
//        Print all userIds whose ids are less than 5 on the console ==> id si 5 den kucuk olan tum userid lerini konsolunu yazdirin
        List<Integer> list2 = jsonPath.getList("findAll{it.id<5}.userId");
