...
public class GetCustomer extends GmiBankBaseUrl {
    ...
    public void gmiBankCustomer() {
        ...
        Customer expectedData = new Customer(110472, "Melva", "Bernhard", "A", "chas.kuhlman@yahoo.com", "192-580-3408", "192-580-3408", "40207",
                "Apt. 634 579 Eliseo Rapids, Deanaside, AZ 53872", "New Jordanhaven", "523-50-1191", "2021-11-30T21:00:00Z", false, country, "", user, accountList);
        System.out.println("expectedData = " + expectedData);

        Response response = given().spec(spec).headers("Authorization", "Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJiYXRjaF95dXp1YyIsImF1dGgiOiJST0xFX0FETUlOIiwiZXhwIjoxNjc5ODU3MzcyfQ.iUh_MF0w19tnARXNrPmMgy58bpLm2k6x-AxK8O_vGYqazZ4sHpyEIIoHhLU4VX7vM8nt3GtF-BVZWctOPYbtSg").get("/{first}/{second}/{third}");
